...
export class FuseAlertComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    @Input() appearance: FuseAlertAppearance = 'fill';
    ...
    ngOnInit(): void
    {
        ...
        this._fuseAlertService.fuseAlertData
            .pipe(takeUntil(this._unsubscribeAll)
            )
            .subscribe((fuseAlertData) => {
                this.dismiss();

                  // Show the alert
                if(fuseAlertData){
                    this.alertMessage=fuseAlertData.message
                    this.alertTitle=fuseAlertData.alertTitle
                    this.type=fuseAlertData.type
                }
                this.dismissFuseAlert()
            });    
